...
$(function() {
 ...
 $(function() {
	 $(".c-edit").click(function(){
			...
			var methodval = $(this).attr("data-method");
			$(".access_chk").prop("checked", false);
			$.ajax({
          		type: "POST",
          		url: link,
          		dataType: "json",
          		data:{id:eid,action:"edit",method:methodval},
          		success: function(data){
          			if(methodval=='usergroup'){
          				$('#'+data.pid+'_eid').val(data.eid);
          				$('#'+data.pid+'_name').val(data.name);
          				$('#'+data.pid+'_btn').text('Save');
          				$.each(data.access, function (i) {
          				    $.each(data.access[i], function (key, val) {
          				    	$('#'+data.pid+'_per_'+val).prop('checked', true);
          				    });
          				});
          			}
          		}
	 ...
	 $(".c-delete").click(function(){
			...
			$.ajax({
	       		...
	       		url: link,
	       		dataType: "json",
	       		data:{id:eid,action:"del",method:methodval},
	       		success: function(data){
	       			e.closest('tr').hide();
	       		}
			});
	 });
	 $(".c-approve").click(function(){
	  		var eid = $(this).attr("data-eid");
			var e = $(this);
	  		var link = $(this).attr("data-link");
			var base = $(this).attr("data-base");
			...
			$.ajax({
	    		...
	    		url: link,
	    		dataType: "json",
	    		data:{id:eid,action:"approve",method:methodval},
	    		success: function(data){
	    			$('#status_'+eid).html('<span class="badge_style b_done">Active</span>');	
	    		}
			});
	 });
	 $(".c-suspend").click(function(){
	  		var eid = $(this).attr("data-eid");
			var e = $(this);
	  		var link = $(this).attr("data-link");
			var base = $(this).attr("data-base");
			...
			$.ajax({
	    		...
	    		url: link,
	    		dataType: "json",
	    		data:{id:eid,action:"disable",method:methodval},
	    		success: function(data){
	    			$('#status_'+eid).html('<span class="badge_style b_suspend">Disabled</span>');
	    		}
			});
	 });
 });
